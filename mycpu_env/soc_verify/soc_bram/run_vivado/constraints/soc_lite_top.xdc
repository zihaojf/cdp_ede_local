...
#Unconstrained ports (num_data, btn_key_col, btn_key_row: no such peripherals on Nexys4 DDR)
#are downgraded to warnings so bitstream generation can proceed.
...
#btn_step: BTNC/BTNU
set_property PACKAGE_PIN N17 [get_ports {btn_step[0]}]
set_property PACKAGE_PIN M18 [get_ports {btn_step[1]}]
